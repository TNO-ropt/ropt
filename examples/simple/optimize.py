...
This is the no-ceremony path: a configuration dictionary, a start vector, and a
per-realization objective callback that returns a scalar. No executor is opened,
so the optimization runs sequentially on the calling thread.
"""
