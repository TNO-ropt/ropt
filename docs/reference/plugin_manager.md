...
The [`PluginManager`][ropt.plugins.PluginManager] discovers plugins
...
The module-level [`get_plugin`][ropt.plugins.get_plugin] and
[`get_plugin_name`][ropt.plugins.get_plugin_name] functions do the same
...
::: ropt.plugins.PluginType
::: ropt.plugins.get_plugin
::: ropt.plugins.get_plugin_name
::: ropt.plugins.register_plugin
