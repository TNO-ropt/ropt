...
| [The external backend](../optimizer_setup/configuration_sections.md#external-backend) | The built-in plugins, and any plugin class in an importable module | Plugin instances of classes defined in a function or a notebook |
