...
class Results(ABC):
    ...
    1. An optional batch ID, which may be generated by the function evaluator.
    ...
    2. A dictionary of metadata to be added by optimization steps. This contains
    ...
    def to_dataframe(
        ...
        Info: The data frame index
            ...
            the the `batch_id` (if not None) field is also prepended to the
            index of the resulting frame.
