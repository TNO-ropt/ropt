...
from ropt.workflow.evaluators import FunctionEvaluator, ParallelEvaluator
...
if TYPE_CHECKING:
    ...
    from ropt.workflow.compute_steps import ComputeStep
    from ropt.workflow.evaluators import EvaluationFunctionCallback, Evaluator

_T = TypeVar("_T")


_active_session: ContextVar[Session | None] = ContextVar(
    "ropt_highlevel_session", default=None
)
