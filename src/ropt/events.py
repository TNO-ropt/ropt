...
class OptimizationEvent:
    ...
    triggered during the execution of the workflow. These callbacks accept a
    single `OptimizationEvent` object containing information about the event.
    ...
    Attributes:
        ...
        config:     The current configuration object of the executing workflow
